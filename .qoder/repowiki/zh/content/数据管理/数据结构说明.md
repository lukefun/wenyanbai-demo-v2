...
这是一个基于Web的文言文学习应用，采用间隔重复算法进行记忆训练。该应用提供了文言文虚词和实词的学习功能，包含1000+张含义卡片和900+道测试题目。系统通过本地存储保存用户的学习进度和统计数据。

**更新** 数据量已大幅扩展，从原有的165张学习卡片扩展到1000+张，从72道测试题目扩展到900+道。
...
subgraph "数据目录"
CARDS[data/cards.js<br/>1000+张学习卡片]
QUIZ[data/quiz.js<br/>900+道测试题目]
end
HTML --> CARDS
HTML --> QUIZ
JS --> CARDS
...
**章节来源**
- [data/cards.js:1](file://data/cards.js#L1-L1001)
...
**章节来源**
- [data/quiz.js:1](file://data/quiz.js#L1-L907)
...
**更新** 随着数据量的大幅扩展（学习卡片从165张扩展到1000+张，测试题目从72道扩展到900+道），系统在性能优化和数据管理方面面临更大的挑战，需要更加注重数据分页、缓存策略和内存管理等技术手段来保证用户体验。